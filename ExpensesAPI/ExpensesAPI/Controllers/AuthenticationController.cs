...
namespace ExpensesAPI.Controllers
{
    ...
    public class AuthenticationController : ApiController
    {
        ...
        private JwtPackage CreateToken(User user)
        {
            ...
            const string secreteKey = "your secrete key goes here";
            var securityKey = new SymmetricSecurityKey(Encoding.Default.GetBytes(secreteKey));
